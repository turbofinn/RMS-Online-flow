...
const FriesCard = ({ title, description, price, friesImage, onClick }) => {
  return (
    <Card
      sx={{
        width: { xs: "100%", sm: 386 },
...
const FriesSection = ({ friesItems = defaultFriesItems }) => {
